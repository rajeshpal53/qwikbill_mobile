...
import { Card, Title, Paragraph,Button,Avatar, ActivityIndicator } from 'react-native-paper';
  ...
  return (
    ...
    <Avatar.Image 
        ...
        <Card.Content style={{alignSelf:'center'}}>
          <Title style={styles.titleStyle}>{`${login.name} ${login.surname}`}</Title>
          <Paragraph style={styles.paragraph}>ID: {login._id}</Paragraph>
          <Paragraph style={styles.paragraph}>Name: {login.name}</Paragraph>
          <Paragraph style={styles.paragraph}>Surname: {login.surname}</Paragraph>
