...
const EditRoleModal = ({ visible, onClose, selectedOffer }) => {
  ...
  console.log("DATA OF SELECTED ", selectedOffer);
  const roleOptions = [
  ...
  return (
    ...
    >
      <View style={styles.modalContainer}>
        <Formik
          initialValues={{
            userMobile: selectedOffer?.user?.mobile || "",
            userName: selectedOffer?.user?.name || "",
            userRole: selectedOffer?.role?.name || "",
            email: selectedOffer?.user?.email || "",
            selectShop: selectedOffer?.vendor?.shopname || "default",
          }}
              ...
              <View style={styles.formContainer}>
                ...
                <View style={{ marginBottom: 10 }}>
                  ...
                  >
                    {/* <Picker.Item
                      label={
                        selectedOffer ? selectedOffer.role?.name : "Select Role"
                      }
                      // enabled={false}
                    /> */}
